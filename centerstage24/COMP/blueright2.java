...
import org.firstinspires.ftc.teamcode.centerstage24.COMP.TfodJava;
...
public class blueright2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory line1 = drive.trajectoryBuilder(startPose)
                .lineTo(new Vector2d(36, -51), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        //middle/level 2 trajs
        Trajectory middledropline = drive.trajectoryBuilder(line1.end())
                .lineTo(new Vector2d(36, -44), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory reverse = drive.trajectoryBuilder(line1.end())
                .lineTo(new Vector2d(36, -76), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
