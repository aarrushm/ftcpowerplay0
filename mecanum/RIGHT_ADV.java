...
@Autonomous(name="RIGHT_ADV", group="Autonomous")
public class RIGHT_ADV extends LinearOpMode {
    @Override
    public void runOpMode() {
        ...
        Trajectory strafe1 = drive.trajectoryBuilder(startPose)
                .strafeTo(new Vector2d(30.3, -69.3), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory forward1 = drive.trajectoryBuilder(strafe1.end())
                .splineTo(new Vector2d(30.3, -61.5), (Math.toRadians(90)), SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory reverse1 = drive.trajectoryBuilder(forward1.end())
                .lineTo(new Vector2d(30.3, -69.3), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory strafe2 = drive.trajectoryBuilder(reverse1.end())
                .strafeTo(new Vector2d(19, -69.3), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory forward2 = drive.trajectoryBuilder(strafe2.end())
                .splineTo(new Vector2d(19, -17.5), (Math.toRadians(90)), SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory forward3 = drive.trajectoryBuilder(forward2.end().plus(new Pose2d(0, 0, Math.toRadians(-90))))
                .splineTo(new Vector2d(71, -17.5), (Math.toRadians(0)), SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory wallreverse = drive.trajectoryBuilder(forward3.end())
                .lineTo(new Vector2d(68, -17.5), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory reverse2 = drive.trajectoryBuilder(wallreverse.end())
                .lineTo(new Vector2d(43, -17.5), SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory strafe3 = drive.trajectoryBuilder(reverse2.end())
                .strafeTo(new Vector2d(50, -30), SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory strafe4 = drive.trajectoryBuilder(strafe3.end())
                .strafeTo(new Vector2d(43, -17.5), SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory forward4 = drive.trajectoryBuilder(strafe4.end())
                .splineTo(new Vector2d(69, -17.5), (Math.toRadians(0)), SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory reverse3 = drive.trajectoryBuilder(forward4.end())
                .lineTo(new Vector2d(23, -17.5), SampleMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
