    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            Trajectory Pole2 = drive.trajectoryBuilder(new Pose2d(),false)
                    .forward(10,SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                    .build();
            ...
            Trajectory Forward = drive.trajectoryBuilder(new Pose2d(),false)
                    .forward(24,SampleMecanumDrive.getVelocityConstraint(40, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                    .build();


            rightslide.MoveToLevelAsync(Slide.level.LEVEL_2);
